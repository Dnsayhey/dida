...
/* clang-format off */
#if 1 /* Enable configuration content */
...
#define LV_COLOR_DEPTH 16  // Match TFT_eSPI's RGB565 format
...
#define LV_USE_ASSERT_STYLE 0  // Disable style asserts for performance
...
#define LV_USE_TFT_ESPI         1  // Enable TFT_eSPI driver integration
